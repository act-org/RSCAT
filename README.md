...
## Install & Setup
1. Install Java SE Runtime Environment 8 (https://www.oracle.com/technetwork/java/javase/downloads/jre8-downloads-2133155.html).
...
"Error: package or namespace load failed for 'rJava':", try to run `Sys.setenv(JAVA_HOME='')` first. If errors still exist, try to uninstall and reinstall Java and R.
