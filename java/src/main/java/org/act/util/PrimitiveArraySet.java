...
/**
 * A set of named primitive arrays, each consisting of the same number of elements. Supports int[], double[],
...
public class PrimitiveArraySet {
    ...
    /**
     * Convert String lists in selected columns to primitive arrays of type of type int[], double[], boolean[],
     * or String[].
     *
     * @param table the table of string contents
     * @param columnTypes a mapping of column names to primitive array types to extract
    ...
    /**
     * Construct a new {@link PrimitiveArraySet}.
     */
    ...
    /**
     * Get a copy of this {@link PrimitiveArraySet} with an additional array.
     *
    ...
    /**
     * Get the array for a given identifier.
     *
    ...
    /**
     * Get a copy array for a given identifier.
     *
     * @param arrayIdentifier the array identifier
     * @return the array
     */
    ...
    /**
     * Get a copy of the array for a given identifier.
     *
     * @param arrayIdentifier the array identifier
     * @return the array
     */
    ...
    /**
     * Get a copy of this {@link PrimitiveArraySet} without the specified array.
     *
    ...
    /**
     * Get a copy of a subset of this {@link PrimitiveArraySet}.
     *
    ...
    public PrimitiveArraySet subset(int startIndex, int endIndex){
        ...
        arrays.entrySet().forEach(array -> newArrays.put(
                array.getKey(), subset(array.getValue(), startIndex, endIndex)));
        int newLength = endIndex - startIndex;
        return new PrimitiveArraySet(newArrays, newLength);
    }

    /**
     * Get a sub-sampling of this {@link PrimitiveArraySet}.
     *
    ...
    public PrimitiveArraySet subSample(int... indices){
        Map<String, Object> newArrays = new HashMap<>();
        arrays.entrySet().forEach(array -> newArrays.put(
                array.getKey(), subSample(array.getValue(), indices)));
        int newLength = indices.length;
        return new PrimitiveArraySet(newArrays, newLength);
    }

    /**
     * Get a set of the the array identifiers for arrays contained by this {@link PrimitiveArraySet}.
     *
    ...
    /**
     * Get the length of the arrays that are part of this {@link PrimitiveArraySet}.
     *
    ...
    /**
     * Sorts the arrays as a group based on the natural sorting order of the specified array.
     *
     * @param arrayId the identifier of the array that should define the sorting order
     ...
     *
     * @param indexes a list of integers with the value of each index corresponding to the destination index
     * @return the new {@link PrimitiveArraySet}
     */
     ...
     * @return the new {@link PrimitiveArraySet}
     */
    private PrimitiveArraySet withArray(String arrayId, Object array, int length){
        if(!this.arrays.isEmpty() && this.length != length){
            throw new IllegalArgumentException("Cannot add array of length " + length
                    + " to set of length " + this.length);
        }
        Map<String, Object> newArrays = new HashMap<>(this.arrays);
        newArrays.put(arrayId, array);
        return new PrimitiveArraySet(newArrays, length);
    }
    ...
    /**
     * Get the {@link Comparator} for indices.
     *
    ...
    /**
     * Get a sorted version of an array according to an index mapping.
     *
     * @param array the primitive array object
    ...
    /**
     * Get a sub-sampling of an array.
     *
     * @param indices the array indices to include in the sampling
     * @return the new {@link PrimitiveArraySet}
     */
    ...
    /**
     * Defines the types of primitive arrays supported and encapsulates support code.
     */
    private enum ArrayTypes{
        ...
        /**
         * Get the {@link ArraySupport} for a given array type.
         *
         * @param arrayType the supported array type
    ...
    private interface ArraySupport{
        ...
        /**
         * Get indexComparator for indices of the given array.
         *
